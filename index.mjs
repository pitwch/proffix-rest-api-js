...
export default class ProffixRestApi {
   ...
   */
  constructor(opt) {
    if (!(this instanceof ProffixRestApi)) {
      return new ProffixRestApi(opt);
    }
  ...
  _setDefaultsOptions(opt) {
    this.url = opt.url;
    this.pxAPIPrefix = opt.pxAPIPrefix || "wp-json";
  ...
  _request(method, endpoint, data, params = {}) {
    ...
    if (
      ...
      headers["User-Agent"] =
        "Proffix REST API - JS Client/" + this.classVersion;
    }
